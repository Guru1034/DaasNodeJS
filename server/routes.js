...
exports['default'] = function (app) {
  ...
  // Insert routes below
  // Since we removed things folder
  app.use('/api/mappings', require('./api/mappings'));
  app.use('/api/defaults', require('./api/defaults'));
  app.use('/api/exports', require('./api/exports'));
